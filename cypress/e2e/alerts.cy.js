...
describe('Context: Multiple Button Actions', { baseUrl: 'https://demoqa.com' }, () => {
  beforeEach(() => {
    cy.clearCookies();
    cy.visit('/alerts');
  });
  ...
  it('Check alert confirmation', () => {
    ...
    cy.on('window:confirm', stub); // when this confirmation command initiated
    // store and give the control to stub function
